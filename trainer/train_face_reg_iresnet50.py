...
from src.models.backbones.iresnet import IResNet
...
class Trainer:
    ...
    def build_model(self):
        self.backbone = IResNet(**self.arch_config['Backbone']).cuda()
...
if __name__ == '__main__':
    config = yaml.load(open('configs/face_reg_iresnet.yml'))
